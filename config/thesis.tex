...
\usepackage{pdfpages}
\usepackage[style=iso-authoryear, backend=biber]{biblatex}  % bibtex
...
\usepackage{packages/listings-rust} % listing related package
\usepackage{titletoc}
...
\setcounter{tocdepth}{2}	% TOC depth numbering set to 3
