...
En ce qui concerne le module \textit{utilitaire}, le choix d'un pipeline a été
fait. Il est composé de 4 étapes. 
...
Ce module contient les  binaires en ligne de commande pour traiter les données.
Il s'agit de l'implémentation concrète des différents algorithmes de la librairie.
Les implémentations des utilitaires sont faite à l'aide d'une crate,
\textit{clap} pour lire les arguments de la ligne de commande.
